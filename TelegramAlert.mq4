...
//--- input parameters
input string InpChannelName="nyobaintelegrambot";//Channel Name
input string InpToken="5271119283:AAHUVDABoihIe-fqyYGYnybFV3yqr2fy9J4";//Token
extern string mySigalname = "Golden Strike";
